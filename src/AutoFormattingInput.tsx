...
import { Pattern, InputType, SelectionPattern, typeDict } from './types';

type AutoFormattingInputProps = Omit<
...
>(({ pattern, value, onValueChange, type, ...props }, forwardedRef) => {
  ...
  const ref = (forwardedRef ?? inputRef) as RefObject<HTMLInputElement>;
  ...
  const handleInput = (
    ...
    newValue = regexFilter(newValue, regex);
    ...
    requestAnimationFrame(() => {
      ...
      ref.current?.setSelectionRange(newSelection, newSelection);
    });
  };
